...
class RangeIntersectionTest < Minitest::Test
  ...
  def test_anm_intersection_performance
    def day(n)
      (n * 24 * 60 * 60)
    end
    a = Time.now
    (
      ...
      MultiRange.new([
        ...
        day(8)..(day(8) + 9 * 60 * 60),
        day(9)..(day(9) + 9 * 60 * 60),
        day(10)..(day(10) + 9 * 60 * 60),
        day(11)..(day(11) + 9 * 60 * 60),
        day(12)..(day(12) + 9 * 60 * 60),
        day(13)..(day(13) + 9 * 60 * 60),
        day(14)..(day(14) + 9 * 60 * 60),
        day(15)..(day(15) + 9 * 60 * 60),
        day(16)..(day(16) + 9 * 60 * 60),
        day(17)..(day(17) + 9 * 60 * 60),
        day(18)..(day(18) + 9 * 60 * 60),
        day(19)..(day(19) + 9 * 60 * 60),
        day(20)..(day(20) + 9 * 60 * 60),
        day(21)..(day(21) + 9 * 60 * 60),
        day(22)..(day(22) + 9 * 60 * 60),
        day(23)..(day(23) + 9 * 60 * 60),
        day(24)..(day(24) + 9 * 60 * 60),
        day(25)..(day(25) + 9 * 60 * 60),
        day(26)..(day(26) + 9 * 60 * 60),
        day(27)..(day(27) + 9 * 60 * 60),
        day(28)..(day(28) + 9 * 60 * 60),
        day(29)..(day(29) + 9 * 60 * 60),
      ])
    ).ranges
    b = Time.now
    puts "Took: #{b - a}"
